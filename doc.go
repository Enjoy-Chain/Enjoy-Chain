...
var defaultUsage = `enjoy-chain <cmd> [options...]

SCD (slowly-changing dimensions) Store (enjoy-chain) provides an interface for storing
...
Global Options:
	...
	-mongo.uri <uri>	Specify one or more MongoDB hosts [default: localhost/enjoy-chain].
...
var putUsage = `enjoy-chain put <key> <object>
...
var getUsage = `enjoy-chain get <key>
...
var keysUsage = `enjoy-chain keys

Gets a list of keys in the store.
`

var logUsage = `enjoy-chain log <key>

Returns an ordered set of diffs for the object making up the log.
`

var httpUsage = `enjoy-chain http [--host=<host>] [--port=<port>]
...
var unsubscribeUsage = `enjoy-chain unsubscribe email [emails...]
